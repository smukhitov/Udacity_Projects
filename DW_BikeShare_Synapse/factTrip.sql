...
insert into bikeshare.dbo.etl_factTrip
(
	rider_id,
	trip_id,
	date_id,
...
select distinct
	...
	start_station_id,
	end_station_id	   
from bikeshare.dbo.base_factTrip
...
select	rider_id,
		...
		start_station_id,
		end_station_id
from	bikeshare.dbo.etl_factTrip
...
from ( 	select	 distinct
				 ...
				 stg.rider_age,
				 stg.trip_duration
		from bikeshare.dbo.base_factTrip stg
		inner join bikeshare.dbo.etl_factTrip ft on stg.trip_id = ft.trip_id
		...
		select	   trip_id
				  ...
				  ,rider_age
				  ,trip_duration
		from	bikeshare.dbo.factTrip
	 ) x inner join bikeshare.dbo.factTrip f on x.trip_id = f.trip_id

--insert into prod
insert into bikeshare.dbo.factTrip
(
				   trip_id
				  ,SK_rider_id
				  ,SK_station_id
